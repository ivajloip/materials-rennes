...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.3\textwidth]{./assembly.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{./de-Bruijn-graph1.png}
  \caption{De Bruijn graph}
  \label{fig:de-bruijn-graph}
\end{figure}
%end subsubsection Definition of de Bruijn graph
